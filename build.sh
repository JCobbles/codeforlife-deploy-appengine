...
pip install -t lib git+https://github.com/ocadotechnology/codeforlife-portal.git@test_settings 
pip install -t lib git+https://github.com/riaJha97/aimmo.git@users_per_game
